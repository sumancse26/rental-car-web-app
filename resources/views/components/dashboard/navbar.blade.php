<header>
    <nav aria-label="menu nav" class="bg-gray-800 pt-2 md:pt-1  px-1 mt-0 h-auto fixed w-full z-20 top-2">
        ...
        <div class="flex flex-wrap items-center">
            ...
            <div class="flex w-full items-center content-center justify-between md:w-1/3 md:justify-end">
                    ...
                    <li class="flex-1 md:flex-none md:mr-3">
                        <div class="relative inline-block">
                            <button onclick="toggleDD('myDropdown')" class="drop-button text-white py-2 px-2">
                                <span class="pr-2"><i class="em em-robot_face"></i></span> User <svg
