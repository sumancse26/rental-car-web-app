<form class="max-w-md mx-auto mt-8 border-2 border-gray-500 h-2/3 p-5 rounded rounded-5"
    action="{{ route('user.register') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <h6 class="flex justify-center">User Registration</h6>
    <div class="pt-5">
    ...
    <div class="flex gap-2">
        <a href="{{ route('home') }}"
            class="flex justify-center text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Cancel</a>
